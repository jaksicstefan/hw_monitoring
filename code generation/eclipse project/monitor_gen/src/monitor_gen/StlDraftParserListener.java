...
public interface StlDraftParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code PrevIdentifier}
	 * labeled alternative in {@link StlDraftParser#previous_temporal_expression}.
	 * @param ctx the parse tree
	 */
	void enterPrevIdentifier(StlDraftParser.PrevIdentifierContext ctx);
	/**
	 * Exit a parse tree produced by the {@code PrevIdentifier}
	 * labeled alternative in {@link StlDraftParser#previous_temporal_expression}.
	 * @param ctx the parse tree
	 */
	void exitPrevIdentifier(StlDraftParser.PrevIdentifierContext ctx);
	/**
	 * Enter a parse tree produced by the {@code PrevPrevPTE}
	 * labeled alternative in {@link StlDraftParser#previous_temporal_expression}.
	 * @param ctx the parse tree
	 */
	void enterPrevPrevPTE(StlDraftParser.PrevPrevPTEContext ctx);
	/**
	 * Exit a parse tree produced by the {@code PrevPrevPTE}
	 * labeled alternative in {@link StlDraftParser#previous_temporal_expression}.
	 * @param ctx the parse tree
	 */
	void exitPrevPrevPTE(StlDraftParser.PrevPrevPTEContext ctx);
	/**
	 * Enter a parse tree produced by the {@code PrevLeftPteRight}
	 * labeled alternative in {@link StlDraftParser#previous_temporal_expression}.
	 * @param ctx the parse tree
	 */
	void enterPrevLeftPteRight(StlDraftParser.PrevLeftPteRightContext ctx);
	/**
	 * Exit a parse tree produced by the {@code PrevLeftPteRight}
	 * labeled alternative in {@link StlDraftParser#previous_temporal_expression}.
	 * @param ctx the parse tree
	 */
	void exitPrevLeftPteRight(StlDraftParser.PrevLeftPteRightContext ctx);
	/**
	 * Enter a parse tree produced by the {@code PrevLeftBoolExprRight}
	 * labeled alternative in {@link StlDraftParser#previous_temporal_expression}.
	 * @param ctx the parse tree
	 */
	void enterPrevLeftBoolExprRight(StlDraftParser.PrevLeftBoolExprRightContext ctx);
	/**
	 * Exit a parse tree produced by the {@code PrevLeftBoolExprRight}
	 * labeled alternative in {@link StlDraftParser#previous_temporal_expression}.
	 * @param ctx the parse tree
	 */
	void exitPrevLeftBoolExprRight(StlDraftParser.PrevLeftBoolExprRightContext ctx);
	/**
