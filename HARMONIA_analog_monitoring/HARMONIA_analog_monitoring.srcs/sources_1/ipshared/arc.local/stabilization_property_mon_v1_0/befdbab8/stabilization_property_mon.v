...
module stabilization_property_mon #(parameter DIV_TIME=1, STAB_TIME=1)(
    input clk,
    input rst,    
    input trigger,
	input P,
	...
	output submon_sig_2
        ...
        assign __submonitor_error_sig0 = buf_lsb_out;
...
//    	);
        ...
        shift_reg_buffer#(DIV_TIME+STAB_TIME) my_sh_reg(
        .clk(clk),
        .rst(rst),
        .input_sig(( trigger == 1 ) && ( _sub1000 )),
        .lsb_out(buf_lsb_out)    
        );

    	once_0_Tau_monitor0#(STAB_TIME) __submon_instance1 (
    	.clk(clk),
    	.rst(rst),
    	.XXX(!( P )),
    	...
    	once_0_Tau_monitor1#(DIV_TIME) __submon_instance2 (
    	.clk(clk),
    	.rst(rst),
      ...
      //assign satisfied = ( __submonitor_error_sig0 ) && ( !__submonitor_error_sig2 );
      
      assign satisfied = ( !__submonitor_error_sig0 ) || ( !__submonitor_error_sig2 );  //(not p) OR q
      //assign satisfied = ( !__submonitor_error_sig0 ) || ( __submonitor_error_sig2 );  //(not p) OR q
      assign err = !satisfied;
      
      assign submon_sig_0 = __submonitor_error_sig0;
      assign submon_sig_2 = __submonitor_error_sig2;
    endmodule
          ...
          case(state)
            ...
            2'b10: begin
                ...
                if (XXX == 1'b1) begin
                    ...
                    state <= 2'b11;
                    counter <= {7{1'b0}}; //This statement is not mandatory - can be omitted
                    u <= 1'b0;                
                end
            end
            2'b11: begin
          ...
          case(state)
            ...
            2'b10: begin
                ...
                if (XXX == 1'b1) begin
                    ...
                    state <= 2'b11;
                    counter <= {8{1'b0}}; //This statement is not mandatory - can be omitted
                    u <= 1'b0;                
                end
            end
            2'b11: begin
